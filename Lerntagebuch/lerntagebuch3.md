...
- Die grobe ´BossPhase´ Struktur wurde erneut etwas geändert: Statt einen Pointer auf die momentane Phase, enthält die BossPhase Oberklasse nun eine Liste von Aktionen die gleichzeitig ausgeführt werden.
