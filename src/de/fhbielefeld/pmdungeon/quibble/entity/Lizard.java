...
public class Lizard extends Creature
{
	 ...
	 * {@link Lizard#setPosition(float, float)}. This way it can be placed anywhere in the dungeon.
	 * @param x x position
	 * @param y y position
	 */
	public Lizard(float x, float y)
	{
		...
		this.animationHandler.addAsDefaultAnimation(Creature.ANIM_NAME_IDLE_R, 4, 5, "assets/textures/entity/lizard/lizard_m_idle_right_anim_f.png", 4);
		
		//Other animations
		this.animationHandler.addAnimation(Creature.ANIM_NAME_IDLE_L, 4, 5, "assets/textures/entity/lizard/lizard_m_idle_left_anim_f.png", 4);
		
		this.animationHandler.addAnimation(Creature.ANIM_NAME_RUN_R, 4, 2, "assets/textures/entity/lizard/lizard_m_run_right_anim_f.png", 4);
		this.animationHandler.addAnimation(Creature.ANIM_NAME_RUN_L, 4, 2, "assets/textures/entity/lizard/lizard_m_run_left_anim_f.png", 4);
	}
	...
	protected void updateLogic()
	{
		...
		List<Entity> t = (List<Entity>) this.getLevel().getEntitiesInRadius(5, 5, 9999, this);
	}
